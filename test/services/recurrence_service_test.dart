...
void main() {
  ...
  group('occurrences（发生日窗口）', () {
    ...
    test('间隔序列（艾宾浩斯默认 1,2,4,7,15,30）：第 1 次起始日当天，之后按绝对天数', () {
      final dates = service.occurrences(
        ruleType: 'sequence',
      ...
      // offsets 是「距起始日的绝对复习日」：+1、+2、+4、+7、+15、+30 天
      // （P1-7 语义修正：与 UI hint「第 1、2、4、7、15、30 天复习」一致）。
      expect(dates, [
        '2026-08-05', // 第 1 次
        '2026-08-06', // +1
        '2026-08-07', // +2
    ...
    test('间隔序列自定义序列（绝对天数）', () {
      ...
      expect(dates, ['2026-08-05', '2026-08-07', '2026-08-10']);
    });
